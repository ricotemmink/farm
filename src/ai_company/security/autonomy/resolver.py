...
from ai_company.core.enums import AutonomyLevel, SeniorityLevel, compare_seniority
...
from ai_company.security.action_types import ActionTypeRegistry  # noqa: TC001
