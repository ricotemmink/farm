...
src/synthorg/
  ...
  memory/         # Pluggable MemoryBackend, retrieval pipeline (hybrid dense+BM25 sparse with RRF fusion), tool-based injection strategy, agentic query reformulation, org memory, consolidation, embedding/ (LMEB-ranked model selection, embedder config resolution, fine-tuning pipeline)
