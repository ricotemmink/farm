...
- **Landing page**: `site/` (Astro + React islands via `@astrojs/react`). Includes `/get/` CLI install page, contact form, interactive dashboard preview, SEO
...
- **Landing page**: dependencies in `site/package.json` (Astro 6, @astrojs/react, React 19, Tailwind CSS 4)
