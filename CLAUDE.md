...
- **ALWAYS read the relevant `docs/design/` page** before implementing any feature or planning any issue. [DESIGN_SPEC.md](docs/DESIGN_SPEC.md) is a pointer file linking to the 10 design pages.
...
- **Design spec**: `docs/design/` (10 pages), **Architecture**: `docs/architecture/`, **Roadmap**: `docs/roadmap/`
